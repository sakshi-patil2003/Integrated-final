...
const AdmissionProcess = () => {
  ...
  return (
    <div
      className="px-8 md:px-16 md:py-10 text-center relative bg-contain bg-no-repeat bg-center"
    ...
    >
      ...
      <div className="relative z-10">
        ...
        <p className="md:text-lg mb-6 text-[#555555]">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4 md:gap-8 mx-auto">
          ...
          >
            ...
            <p className="text-sm md:text-lg">Fill out the online application form on our website.</p>
          </div>
          ...
          >
            ...
            <p className="text-sm md:text-lg">Submit the required documents (mark sheets, ID, etc.)</p>
          </div>
          ...
          >
            ...
            <p className="text-sm md:text-lg">Pay the application fee securely online.</p>
          </div>
          ...
          >
            ...
            <p className="text-sm md:text-lg">Attend the counseling and interview session.</p>
          </div>
          ...
          >
            ...
            <p className="text-sm md:text-lg">Confirm your seat and join ICEM College!</p> {/* Updated text color */}
          </div>
        </div>
      </div>
      ...
      <div className="relative z-20 px-8 md:px-16 py-4">
        <div className="text-center mb-2">
          <h1 className="text-3xl md:text-5xl font-bold text-[#555555] mb-4 md:mb-6 mt-2">Admissions 
            <span className="text-[#f37021]"> Open </span> for 2025!
          </h1>
          <p className="text-lg md:text-xl text-[#555555] mb-4 md:mb-8">
