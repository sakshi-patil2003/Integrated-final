  ...
  return (
    <div className="w-full bg-[#FCFAEE] py-10 px-4 sm:px-6 md:px-10 lg:px-16 overflow-hidden">
      <div className="flex flex-col md:flex-row gap-8 items-stretch">
        ...
        >
          <div>
            <h1 className="text-2xl  md:text-5xl font-bold text-[#555555] mb-2">
              Invent, Integrate, Impact.
            </h1>
            <h2 className="text-lg sm:text-xl md:text-2xl font-semibold text-[#f37021] mb-4">
              Integrated BBA + MBA
            ...
            <p className="text-sm sm:text-base md:text-lg mb-6 text-[#555555]">
              Indira College of Engineering & Management offers a career-focused 5-year Integrated BBA MBA course after 12th, 
              blending classroom learning with real-world exposure. The vibrant campus features modern classrooms, libraries, 
              labs, spacious hostels, reliable transportation, a hygienic canteen, active sports facilities, and dynamic student
               events. With expert mentoring and an industry-aligned curriculum, it’s one of the best colleges for integrated 
               BBA MBA in Pune.
